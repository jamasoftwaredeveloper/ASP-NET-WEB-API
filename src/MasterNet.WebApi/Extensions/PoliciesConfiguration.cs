    ...
    public static class PoliciesConfiguration
    {
        public static IServiceCollection AddPoliciesServices(
            this IServiceCollection services
                      ...
                      {
                          opt.AddPolicy(
                              PolicyMaster.CURSO_READ, policy => policy.RequireAssertion(
                          ...
                          opt.AddPolicy(
                                PolicyMaster.CURSO_CREATE, policy => policy.RequireAssertion(
                                    context => context.User.HasClaim(
                                        c => c.Type == CustomClaims.POLICIES && c.Value == PolicyMaster.CURSO_CREATE
                                    )
                                    )
                          );

                          opt.AddPolicy(
                              PolicyMaster.CURSO_UPDATE, policy => policy.RequireAssertion(
                                  context => context.User.HasClaim(
                          ...
                          opt.AddPolicy(
                                PolicyMaster.CURSO_DELETE, policy => policy.RequireAssertion(
                                    context => context.User.HasClaim(
                          ...
                          opt.AddPolicy(
                                PolicyMaster.INSTRUCTOR_READ, policy => policy.RequireAssertion(
                                    context => context.User.HasClaim(
                          ...
                          opt.AddPolicy(
                                PolicyMaster.INSTRUCTOR_CREATE, policy => policy.RequireAssertion(
                                context => context.User.HasClaim(
                          ...
                          opt.AddPolicy(
                                PolicyMaster.INSTRUCTOR_UPDATE, policy => policy.RequireAssertion(
                                    context => context.User.HasClaim(
                          ...
                          opt.AddPolicy(
                                  PolicyMaster.INSTRUCTOR_DELETE, policy => policy.RequireAssertion(
                                      context => context.User.HasClaim(
                                          c => c.Type == CustomClaims.POLICIES && c.Value == PolicyMaster.INSTRUCTOR_DELETE
                                      )
                                      )
                            );
                          ...
                          opt.AddPolicy(
                                  PolicyMaster.COMENTARIO_UPDATE, policy => policy.RequireAssertion(
                                  context => context.User.HasClaim(
                                  c => c.Type == CustomClaims.POLICIES && c.Value == PolicyMaster.COMENTARIO_UPDATE
                                  )
                                  )
                           );
